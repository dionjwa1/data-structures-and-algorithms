...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let filtered = arr.filter(number => !forbiddenValues.includes(number));
  return filtered;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let filtered = arr.filter(n => n.baseStat > minBaseStat);
  let newArray = filtered.filter(n => n.stat.name);
